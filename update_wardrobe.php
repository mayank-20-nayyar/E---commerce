...
$fileContent = addslashes($fileContent);
	...
	$query="INSERT INTO wardrobe (id ,username ,tagline ,description ,category ,image) VALUES(NULL, '$user', '$tagline', '$description', '$category', '$fileContent')" or die(mysqli_error($con));
